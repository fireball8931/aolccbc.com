<nav class="navbar navbar-dark bg-dark navbar-expand-md navbar-toggler" style="min-height: 50px;">
    <a class="navbar-brand" href="/"><img alt="AOLCC Logo" src="/images/logo-dark.webp"
            style="display: inline-block;"></a>
    <ul class="navbar-nav mr-auto">
        <li class="nav-item dropdown">
            <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown"
                href="#" id="navbarDropdown3" role="button">CALL US TODAY</a>
            <div aria-labelledby="navbarDropdown3" class="dropdown-menu">
                <a class="dropdown-item" href="tel:16045324040" target="_blank">604-532-4040<br>
                    Langley Campus</a> <a class="dropdown-item" href="tel:16048553315" target="_blank">604-855-3315<br>
                    Abbotsford Campus</a>
            </div>
        </li>
    </ul>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown"
                    href="/about-us" id="navbarDropdownMenuLink">ABOUT US</a>
                <ul aria-labelledby="navbarDropdownMenuLink" class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="/about-us" target="_blank">LEARN ABOUT AOLCC</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="/about-us/why-aolcc/" target="_blank">WHY AOLCC?</a>
                    </li>
                    ...
                    <!--<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="/learn2learn"><i class="fas fa-leaf navleaf"></i> LEARN TO LEARN</a>
            ...
            </li><!-- <li class="nav-item active"> <a class="nav-link" href="/admissions.html">ADMISSIONS</a> </li>-->
            <li class="nav-item active">
            ...
            <li class="nav-item dropdown">
                <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown"
                    href="#" id="navbarDropdown2" role="button">STUDENT RESOURCES</a>
                <div aria-labelledby="navbarDropdown2" class="dropdown-menu">
                    <a class="dropdown-item" href="/downloads/GetHelpFromAOLCC.exe" target="_blank">Get Help from
                        ...
                        target="_blank">Here2Talk - Free Mental Health Resources</a> <a class="dropdown-item"
                        href="//acmeweb.academyoflearning.net/Forms/AttendanceLogin.aspx" target="_blank">Attendance
                        Tracker</a> <a class="dropdown-item" href="//mynew.aolcc.ca" target="_blank">myAOLCC</a> <a
                        class="dropdown-item" href="//www.youtube.com/watch?v=MowAXB-hPVs" target="_blank">***NEW
                        Orientation***</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="//download.respondus.com/lockdown/download.php?id=281950612">Lockdown
                        Browser Installer</a>
                    ...
                    <a class="dropdown-item"
                        href="//app.businessconnect.telus.com/download/TELUS%20Business%20Connect.exe">RingCentral</a>
                </div>
            </li>
        </ul>
    </div>
